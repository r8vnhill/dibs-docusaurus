...
<details>
    ...
    <Tabs groupId={"os"}>
        <TabItem value="Windows" label="Windows">
            ...
            New-Item -Path "$NotificationsMainDir\EmailNotificationSystem.kt" `
                -ItemType 'file' -Force
            New-Item -Path "$NotificationsMainDir\NotificationHandler.kt" `
                -ItemType 'file' -Force
            New-Item -Path "$NotificationsTestDir\EmailNotificationSystemTest.kt" `
                -ItemType 'file' -Force
            ```
        </TabItem>
        <TabItem value="Windows (corto)" label="Windows (corto)">
