...
<details>
    ...
    tasks.register("setupBoundsModule") {
        ...
        doLast {
            ...
            createFileIfNotExists(
                rootProject.file(baseDir), "build.gradle.kts", "// Intentionally left blank"
            )
    ...
    Preocupate de que el plugin `bounds` esté aplicado en el archivo `build.gradle.kts` del módulo principal.
