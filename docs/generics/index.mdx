...
<ModuleSetup module='intro' task='setupIntroModule'>
    ...
    <Explanation>
        Esta tarea de Gradle crea un módulo para la lección actual, con un directorio de código fuente principal y de prueba, y un archivo `build.gradle.kts` vacío. También agrega el módulo al archivo `settings.gradle.kts` si no está presente. Puedes utilizar esta tarea para configurar los módulos de las lecciones en el proyecto.
    </Explanation>
