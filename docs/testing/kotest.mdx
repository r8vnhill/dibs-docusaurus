...
<BoxedTabs>
    <TabItem value={"StringSpec"} label={"StringSpec"}>
        ```kotlin title="intro/src/test/kotlin/com/github/username/basics/MyTest.kt" showLineNumbers
    ...
    <TabItem value={"WordSpec"} label={"WordSpec"}>
        ```kotlin title="intro/src/test/kotlin/com/github/username/basics/MyWordSpecTest.kt" showLineNumbers
        package com.github.username.basics
    ...
    <TabItem value={"BehaviorSpec"} label={"BehaviorSpec"}>
        ```kotlin title="intro/src/test/kotlin/com/github/username/basics/MyBehaviorSpecTest.kt" showLineNumbers
        package com.github.username.basics
    ...
    <TabItem value={"FeatureSpec"} label={"FeatureSpec"}>
        ```kotlin title="intro/src/test/kotlin/com/github/username/basics/MyFeatureSpecTest.kt" showLineNumbers
        package com.github.username.basics
