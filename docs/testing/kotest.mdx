...
<RepoClone repoName="kotest-intro" />
...
<Tabs>
    <TabItem value={"Windows"} label={"Windows"}>
        ...
        New-Item -Path "$BasicTestDir\MyTest.kt" -ItemType "File" -Force
        ```
    </TabItem>
...
<Tabs>
    <TabItem value={"StringSpec"} label={"StringSpec"}>
        ```kotlin title="basic-tests/src/test/kotlin/com/github/username/basics/MyTest.kt" showLineNumbers
...
En esta lección, exploramos la **automatización de pruebas** y el uso del framework **Kotest** para crear pruebas en Kotlin. Aprendimos sobre el enfoque de desarrollo **TDD** y la integración de **Kotest** en proyectos de Gradle.

### Puntos clave
- **Testing**: Garantiza la fiabilidad y previene regresiones en el software.
- **TDD**: Desarrolla el código a partir de pruebas, asegurando que las funcionalidades cumplan con los requisitos.
- **Kotest**: Framework de pruebas con soporte para *data-driven testing*, *property-based testing* y coroutines.
- **Configuración de Kotest**: Agregamos dependencias y configuramos Kotest en Gradle.
- **Estilos de pruebas**: Diferentes enfoques para escribir pruebas con Kotest.

---
Implementar buenas prácticas de pruebas ayuda a mejorar la calidad y mantenibilidad del código a largo plazo.
