...
3. Se lanza una excepción adecuada si los valores de salud están fuera de los límites permitidos.
...
En la próxima lección nos centraremos en el paso de refactor, aprovechando data-driven testing para mejorar la calidad de nuestras pruebas y reducir la duplicación de código.
