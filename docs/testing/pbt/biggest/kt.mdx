...
import { LanguageCard, QuickCheckCard, ScalaTestCard } from '@site/src/components/cards/LanguageCard'
...
<details>
    ...
    <BoxedTabs groupId={"os"}>
        <TabItem value="Windows" label="Windows">
            ...
            $BiggestTestDir | New-Item -ItemType Directory -Force
            $BiggestMainDir | New-Item -ItemType Directory -Force
            "package $Group.biggest" -replace '\\', '.' | 
                Out-File -FilePath "$BiggestTestDir\BiggestTest.kt"
            "package $Group.biggest" -replace '\\', '.' |
                Out-File -FilePath "$BiggestMainDir\Biggest.kt"
            ```
        </TabItem>
        <TabItem value="Windows (corto)" label="Windows (corto)">
            ```powershell
            ...
            $BiggestTestDir = "biggest\src\test\kotlin\$Group\biggest"
            $BiggestMainDir = "biggest\src\main\kotlin\$Group\biggest"
            $BiggestTestDir, $BiggestMainDir | % { md $_ }
            "package $Group.biggest" -replace '\\', '.' > `
                "$BiggestTestDir\BiggestTest.kt"
            "package $Group.biggest" -replace '\\', '.' > `
                "$BiggestMainDir\Biggest.kt"
            ```
        </TabItem>
        <TabItem value="Linux/Mac" label="Linux/Mac">
            ```bash
            ...
            mkdir -p $BIGGEST_TEST_DIR $BIGGEST_MAIN_DIR
            echo "package ${GROUP//\//.}.biggest" > \
                $BIGGEST_TEST_DIR/BiggestTest.kt
            echo "package ${GROUP//\//.}.biggest" > \
                $BIGGEST_MAIN_DIR/Biggest.kt
            ```
        </TabItem>
    </BoxedTabs>
</details>
