...
<details>
    ...
    <Tabs groupId={"os"}>
        <TabItem value="Windows" label="Windows">
            ...
            $StringsDir = "str-cat\src\test\kotlin\$Group\strings"
            New-Item -Path "$StringsDir\StringConcatenationTest.kt" -ItemType File -Force
            Set-Content -Path "str-cat\build.gradle.kts" -Value "// Intentionally left blank"
            ```
        </TabItem>
        <TabItem value={"Windows (corto)"} label={"Windows (corto)"}>
            ...
            $Group = 'com\github\username'
            $StringsDir = "str-cat\src\test\kotlin\$Group\strings"
            ni "$StringsDir\StringConcatenationTest.kt" -i f -f
        ...
        <TabItem value="Unix" label="Unix">
            ```bash
            GROUP=com/github/username
            STRINGS_DIR="str-cat/src/test/kotlin/$GROUP/strings"
            mkdir -p $STRINGS_DIR
            touch "$STRINGS_DIR/StringConcatenationTest.kt"
            echo "// Intentionally left blank" > str-cat/build.gradle.kts
            ```
        </TabItem>
    </Tabs>
