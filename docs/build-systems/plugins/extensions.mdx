...
<Tabs>
    <TabItem value="Kotlin DSL" label="Kotlin DSL">
        ```kotlin title="./echo/convention-plugins/src/main/kotlin/playground.gradle.kts"
    ...
    <TabItem value="Groovy DSL" label="Groovy DSL">
        ```groovy title="./echo/convention-plugins/src/main/groovy/playground.gradle"
        tasks.register('greet') {
            group = 'playground'
            description = 'Prints a greeting message'
            doLast {
...
<Tabs>
    <TabItem value="Kotlin DSL" label="Kotlin DSL">
        ```kotlin title="./echo/build.gradle.kts"
        // Definir el valor de la propiedad directamente
        ext["module"] = "main"
        ```
    </TabItem>
    <TabItem value="Groovy DSL" label="Groovy DSL">
        ```groovy title="./echo/build.gradle"
        // Definir el valor de la propiedad directamente
        ext.module = 'main'
        ```
    </TabItem>
...
```kotlin title="./echo/convention-plugins/src/main/kotlin/extensions/GreetExtension.kt"
