...
A partir de aquí, ya no estás comenzando desde cero. Tienes un entorno configurado, una herramienta poderosa y un lenguaje expresivo a tu disposición. El escenario está listo: ahora puedes concentrarte en escribir el código que realmente importa.
