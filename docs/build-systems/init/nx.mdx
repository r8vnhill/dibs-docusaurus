...
- [🌐 React Monorepo Tutorial](https://nx.dev/getting-started/tutorials/react-monorepo-tutorial): Guía práctica para crear y escalar aplicaciones React en un monorepo Nx con Vite, Vitest, Playwright y bibliotecas compartidas.
