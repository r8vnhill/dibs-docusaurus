...
- [Tutorial](https://mesonbuild.com/Tutorial.html) de **la documentación oficial de Meson**: Este tutorial oficial muestra paso a paso cómo crear un proyecto con Meson, desde un simple programa en C hasta una aplicación con dependencias externas como GTK. Es especialmente útil porque demuestra **cómo estructurar un proyecto desde cero**, **cómo configurar archivos `meson.build`**, y **cómo automatizar la compilación usando Ninja**, temas directamente relacionados con esta lección. Aunque el ejemplo está en C y usa GTK, los conceptos aplican a cualquier proyecto que utilice Meson como sistema de construcción. Ideal para quienes quieran ir más allá del "Hello World" y explorar el manejo de dependencias.
