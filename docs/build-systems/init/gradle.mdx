...
import GradleInitDetails from '@site/src/components/mdx/build-systems/init/gradle/ProjectStructure';
    ...
    items={[
        <WebPage
            ...
            location={<TODO metadata={{
              "reason": "<OfficialDocumentation>...</OfficialDocumentation>",
            }} />}
        >
...
<ReferenceList
  ...
  items={[
    ...
    >
        <TODO metadata={{
          "reason": "Agregar resumen de la página",
        }}/>
    </WebPage>
  ]}
/>
