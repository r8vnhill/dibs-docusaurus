...
<details>
    ...
    <Tabs groupId={"os"}>
        <TabItem value="Windows" label="Windows">
            ```powershell
            $TasksDir = "convention-plugins\src\main\kotlin\tasks"
            New-Item -Path "$TasksDir\FibonacciTask.kt" -ItemType "File" -Force
            ```
        </TabItem>
        <TabItem value={"Windows (corto)"} label={"Windows (corto)"}>
            ```powershell
            $TasksDir = "convention-plugins\src\main\kotlin\tasks"
            ni "$TasksDir\FibonacciTask.kt" -i 'f' -f
            ```
        </TabItem>
        <TabItem value="Unix" label="Unix">
            ```bash
            TASKS_DIR="convention-plugins/src/main/kotlin/tasks"
            mkdir -p "$TASKS_DIR"
            touch "$TASKS_DIR/FibonacciTask.kt"
            ```
        </TabItem>
    </Tabs>
</details>
...
<details>
    ...
    <Tabs groupId={"os"}>
        <TabItem value="Windows" label="Windows">
            ```powershell
            New-Item -Path "$TasksDir\UppercaseTask.kt" `
                -ItemType "File" -Force
            ```
        </TabItem>
        <TabItem value="Windows (corto)" label="Windows (corto)">
            ```powershell
            ni "$TasksDir\UppercaseTask.kt" -i 'f' -f
            ```
        </TabItem>
        <TabItem value="Unix" label="Unix">
            ```bash
            touch "$TASKS_DIR/UppercaseTask.kt"
            ```
        </TabItem>
    </Tabs>
</details>
...
<div className="language-card-container">
    <MSBuildCard link="/build-systems/tasks/classes/msbuild"/>
    <AntCard link="/build-systems/tasks/classes/ant"/>
    <RakeCard link="/build-systems/tasks/classes/rake"/>
</div>
