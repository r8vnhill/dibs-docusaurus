...
Hemos aprendido cómo definir **tareas personalizadas** en Gradle, usando acciones `doFirst` y `doLast`, así como establecer dependencias entre tareas. También exploramos cómo crear tareas basadas en otras tareas existentes.
