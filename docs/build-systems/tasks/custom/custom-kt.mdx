...
<Tabs groupId={"gradle"}>
    ...
    <TabItem value="Groovy DSL" label="Groovy DSL">
        ...
        apply from: "${conventionPluginsDir}/playground.gradle"
        // ...
        ```
    </TabItem>
</Tabs>
...
<Tabs groupId={"gradle"}>
    ...
    <TabItem value="Groovy DSL" label="Groovy DSL">
        ...
        tasks.register('fib') {
            group = 'Playground'
            description = 'Prints the Fibonacci sequence up to a given number'
...
<Tabs groupId={"gradle"}>
    ...
    <TabItem value="Groovy DSL" label="Groovy DSL">
        ...
        tasks.register('copyCompiledClasses', Copy) {
            group = 'build'
            description = 'Copies the compiled classes to a directory'
            dependsOn 'compileKotlin'
