...
3. **Propiedad `number`**: Utilizamos un `Property<Int>` para almacenar el número hasta el cual queremos calcular la secuencia de Fibonacci.
...
```kotlin title="convention-plugins/src/main/kotlin/UppercaseTask.kt"
package tasks
