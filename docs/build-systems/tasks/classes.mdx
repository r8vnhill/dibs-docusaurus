...
tasks.register('fib_10', FibonacciTask) {
    group = 'playground'
    description = 'Calculates the 10th Fibonacci number'
    number = 10
    doFirst {
...
tasks.register('fib_20', FibonacciTask) {
    group = 'playground'
    description = 'Calculates the 20th Fibonacci number'
    number = 20
    doFirst {
...
tasks.register('processText', UppercaseTask) {
    group = 'playground'
    description = 'Process text from input file and write to output file in uppercase'
    inputFile = file('input.txt')
    outputFile = file('output.txt')
...
<Tabs>
    ...
    <TabItem value="Solución">
        ...
        ```kotlin title="convention-plugins/src/main/kotlin/tasks/ParityTask.kt"
        package tasks
    ...
    <TabItem value="Solución (mejorada)">
        ```kotlin title="convention-plugins/src/main/kotlin/tasks/ParityTask.kt"
        package tasks
