...
Esto nos permitirá configurar las convenciones de publicación de Maven en nuestro proyecto. Luego, en el archivo ``build.gradle.kts``, agregaremos la configuración necesaria para publicar en GitHub Packages:
