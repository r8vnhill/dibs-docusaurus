...
import { LanguageCard, BazelCard } from '@site/src/components/cards/LanguageCard'
...
descripción algunos de los diferentes tipos de dependencias que se pueden declarar:
