...
<div className="language-card-container">
    <LanguageCards.CabalCard link="/docs/build-systems/basic-config/cabal" />
    <LanguageCards.SbtCard link="/docs/build-systems/basic-config/sbt" />
    <LanguageCards.SwiftCard link="/docs/build-systems/basic-config/swift" />
</div>
