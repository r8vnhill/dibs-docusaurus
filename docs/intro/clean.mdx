...
Usaremos **Kotlin** para los ejemplos de esta sección. El código está diseñado para ser autoexplicativo, pero si tienes dudas sobre la sintaxis o el lenguaje, puedes consultar la sección [Introducción a Kotlin](/docs/intro/Kotlin).
