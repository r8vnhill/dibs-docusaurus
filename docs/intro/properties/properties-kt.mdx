...
<div className="language-card-container">
    ...
    <LanguageCard
        ...
        language="TypeScript"
        link="/docs/intro/properties/typescript"
    />
</div>
