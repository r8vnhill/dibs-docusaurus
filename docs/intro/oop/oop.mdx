...
En Kotlin, los **objetos** son instancias únicas de clases que se definen con la palabra clave `object`. No necesitan ser instanciados varias veces y se comportan como **singletons**.
