...
En Kotlin, los ciclos están diseñados para ser **expresivos y seguros**. En esta lección exploraremos las principales formas de iteración: bucles `for`, `while` y `do-while`, así como el uso de rangos y la función `repeat`.
