...
- [🌐 "Product type"](https://en.wikipedia.org/wiki/Product_type#:~:text=If%20there%20are%20only%20two,the%20instance%20picked%20from%20A) en *Wikipedia*: Introduce el concepto de **tipo producto** en teoría de tipos y lenguajes de programación, incluyendo su relación con tuplas, registros, lógica (como conjunción) y estructuras algebraicas. Proporciona una base teórica clara para entender cómo los tipos producto representan combinaciones ordenadas de datos y por qué son esenciales en lenguajes funcionales, anticipando temas clave en el diseño de bibliotecas y estructuras de datos en Kotlin.
