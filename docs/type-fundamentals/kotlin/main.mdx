...
- [⏯️ "How to Run Kotlin Code Anywhere with Kotlin Main Functions"](https://youtu.be/aZgyvmjm4gA) (53s) de **Donn Felker**: Demuestra cómo las funciones `main` pueden colocarse en cualquier archivo para pruebas rápidas en el IDE, reforzando su utilidad como herramienta exploratoria durante el desarrollo de bibliotecas.
