...
La función `main` es el **punto de entrada** de un programa en Kotlin. A continuación se muestra un ejemplo simple:
...
Aunque el enfoque de este curso está en el **desarrollo de bibliotecas de software**, es importante conocer cómo funciona esta función.  
La utilizaremos principalmente en los primeros ejemplos ilustrativos, pero su uso irá disminuyendo a medida que incorporemos **pruebas automatizadas** para verificar el comportamiento de nuestras bibliotecas.
