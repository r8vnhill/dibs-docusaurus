...
<BoxedTabs>
    ...
    <TabItem label={"Código completo"} value={"Código completo"}>
        ```python showLineNumbers title="src/intro/oop/singleton.py"
...
<BoxedTabs>
    ...
    <TabItem label={"Código completo"} value={"Código completo"}>
        ```python showLineNumbers title="src/intro/oop/protocols.py"
...
<BoxedTabs>
    ...
    <TabItem label={"Código completo"} value={"Código completo"}>
        ```python showLineNumbers title="src/intro/oop/encapsulation.py"
        class MyClass:
            public_attr: str
            _private_attr: str
            __very_private_attr: str
...
<BoxedTabs>
    ...
    <TabItem label={"Código completo"} value={"Código completo"}>
        ```python showLineNumbers title="src/intro/oop/constructors.py"
        class Movie:
            title: str
