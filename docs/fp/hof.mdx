...
<Tabs>
    <TabItem value="Ejercicio" label="Ejercicio">
        Programa la función filter, que toma una lista de enteros y un predicado y retorna una nueva lista con sólo los elementos que cumplen el predicado; utiliza recursión
    </TabItem>
    <TabItem value="Solución" label="Solución">
        ```kotlin
