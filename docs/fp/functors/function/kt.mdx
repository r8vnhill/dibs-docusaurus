...
Ya vimos que un **funtor** es una estructura que puede ser mapeada, es decir, que admite la aplicación de una función sobre sus elementos internos sin cambiar su estructura. Un ejemplo común es la lista: podemos mapear una función sobre cada elemento de una lista y obtener una nueva lista con los resultados.
...
El funtor función cumple con las dos **leyes fundamentales** de los funtores:

1. **Identidad**: Mapear la función identidad sobre un funtor no cambia el funtor.
