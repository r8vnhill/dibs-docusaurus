...
##  P1) [1.5 pts] Void-safety: Sistema de Gestión de Biblioteca
...
## P2) [1.5 pts] Build-systems: Creación de una Tarea Personalizada para Analizar Comentarios ``TODO`` en el Código Fuente
...
- Cuenta el número de comentarios `TODO` en cada archivo.
- Genera un reporte que liste los archivos que contienen comentarios `TODO` y el número de ocurrencias en cada uno.
...
Añade la posibilidad de configurar la tarea para especificar el tipo de comentarios a buscar (por ejemplo, `TODO`, `FIXME`, `HACK`, etc.).
