...
Asegúrese de que su código siga las normas de **código limpio** y sea **mantenible**, así como las reglas de documentación. Puede utilizar la [guía de estilo](../type-fundamentals/documentation#ejemplo-de-gu%C3%ADa-de-estilo-para-kotlin) de ejemplo proporcionada en el material.
