...
Puede utilizar cualquier característica del lenguaje Kotlin, incluidas las funciones de extensión, las funciones de orden superior, las funciones lambda, las clases selladas, los objetos, las interfaces, las propiedades delegadas, la reflexión o cualquier otra característica que considere necesaria, a menos que se especifique lo contrario en la pregunta.
