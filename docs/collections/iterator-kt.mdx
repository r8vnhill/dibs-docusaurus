...
El **Iterator pattern** es un [patrón de diseño de comportamiento](https://en.wikipedia.org/wiki/Behavioral_pattern) que permite recorrer los elementos de una colección de manera secuencial, sin exponer su representación interna (por ejemplo, si es una lista, conjunto o árbol). Este patrón proporciona una interfaz común para acceder a los elementos, lo que facilita recorrer estructuras de datos de manera consistente y uniforme.
...
<Tabs groupId={"os"}>
    <TabItem value="Windows" label="Windows">
        ...
        New-Item -Path "iterator\src\main\kotlin" -ItemType Directory
        Set-Content -Path "iterator\build.gradle.kts" -Value "// Intentionally left blank"
        ```
    </TabItem>
    <TabItem value="Windows (corto)" label="Windows (corto)">
        ```powershell showLineNumbers
        mkdir iterator\src\main\kotlin
...
```kotlin showLineNumbers title="src/main/kotlin/cl/ravenhill/iterator/Iterator.kt"
...
```kotlin showLineNumbers title="src/main/kotlin/cl/ravenhill/iterator/Iterable.kt"
package cl.ravenhill.iterator
...
```kotlin showLineNumbers title="src/main/kotlin/cl/ravenhill/library/Book.kt"
package cl.ravenhill.library

data class Book(val title: String, val author: String)
```

```kotlin showLineNumbers title="src/main/kotlin/cl/ravenhill/library/Library.kt"
package cl.ravenhill.library
...
```kotlin showLineNumbers title="src/main/kotlin/cl/ravenhill/library/BookIterator.kt"
package cl.ravenhill.library
