...
🌐 Generadores—Learn Python—Free Interactive Python Tutorial. (s. f.). Recuperado 21 de marzo de 2025, de https://www.learnpython.org/es/Generators {/* Última revisión: ??? */}
