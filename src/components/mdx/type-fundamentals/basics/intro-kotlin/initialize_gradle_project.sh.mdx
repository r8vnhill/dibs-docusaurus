```bash showLineNumbers title="Crear un proyecto Kotlin con Gradle con Bash"
#!/usr/bin/env bash
set -euo pipefail
...
Guarda este script en un archivo, por ejemplo `initialize_gradle_project.sh`, y ejecútalo en la terminal:

```bash
bash initialize_gradle_project.sh
```