...
/**
 * A React component that renders a link to a specific GitHub repository.
 *
 * The link includes the GitHub logo and displays the repository path in the format `user/repo`.
 * When clicked, the link opens in a new tab.
 *
...
const GitHubRepoLink = ({ user, repo, addLineBreak = true }) => {
    ...
    return (
        <>
            <a href={repoUrl} target="_blank" rel="noopener noreferrer" className="github-link" style={{ display: 'flex', alignItems: 'center' }}>
                {/* GitHub Logo in SVG format */}
                <svg
